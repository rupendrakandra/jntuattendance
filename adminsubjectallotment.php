<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  $subjectId = mysqli_real_escape_string($db,$_POST['subjId']); 
	  $userId = mysqli_real_escape_string($db,$_POST['userId']); 
	
	
      $sql = "insert into staff_subject_tl(user_id, subject_id, status)values($userId,$subjectId,'Active')";
      ...
      if($result == TRUE) {
        ...
        $msg = "Subject allotment Details are successfully  alloted";
...
<html lang="en">
<head>
<title>Admin  Subject Alootment </title>
<meta charset="UTF-8" />
...
function showUserSubject() {
    ...
    if (deptId == "") {
        ...
        xmlhttp.open("GET","getsubjects.php?deptId="+deptId+"&sem="+sem,true);
        xmlhttp.send();
    }
}
</script>
			...
			<!-- row  -->
			   ...
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <select type="text" class="textbox" name="deptId" id="deptId" required onchange="showUserSubject()">
...
?>
			   ...
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <select type="text" class="textbox" name="sem" id="sem" required onchange="showUserSubject()">
