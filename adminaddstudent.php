<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "insert into user_tl(dept_id,user_type,first_Name,last_Name,email_Id,mobile_No,user_Name,password,status,sem)values($deptId,'$desg','$firstName','$lastName','$emailId','$mobileNo','$userName','$password','Active','$semester')";
      ...
      if($result == TRUE) {
				...
				$mail->Body = "Dear Student your userName".$userName." and password is".$password."";
				$mail->AddAddress($emailId);
				$mail->Send();

        $msg = "Student Details are successfully  inserted";
