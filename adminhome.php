            ...
            <div class="navbar-collapse  collapse">
              ...
              <li class="dropdown">
				 ...
				 <li class="dropdown">
				  ...
				  <ul class="dropdown-menu active">
					<li class="kopie"><a href="adminstudents.php">Students</a></li>
					<li class="kopie"><a href="adminaddstudent.php">AddStudent</a></li>
					</ul>
				</li>
				 ...
				 <li class="dropdown">
				  ...
				  <ul class="dropdown-menu active">
					<li class="kopie"><a href="adminsubjects.php">Subjects</a></li>
					<li class="kopie"><a href="adminaddsubject.php">AddSubject</a></li>
					</ul>
				</li>
				  <li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown">SubjectAllotment <b class="caret"></b></a> 
				  <ul class="dropdown-menu active">
					<li class="kopie"><a href="adminsubjectallotment.php">SubjectAllotment</a></li>
					<li class="kopie"><a href="adminaallotedsubject.php">AllotedSubjects</a></li>
					</ul>
				</li>
