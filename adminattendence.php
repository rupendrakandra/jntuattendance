...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","getstaffatten.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
              ...
              <ul class="nav navbar-nav navbar-right">
               <li ><a href="adminhome.php">Home</a></li>
				...
				<li class="dropdown">
                 ...
                 <li class="active"><a href="adminattendence.php">Attendence</a></li>
...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="adminhome.php">Home</a> / Staff Attendence</span>
