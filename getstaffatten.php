...
<div class="rTableHead">Attendence</div>
...
$q = intval($_GET['q']);
	...
	if ($count > 0) {
		while($row = $rs->fetch_assoc()) {
			...
			echo "<div class='rTableCell'>".$row["userType"]."</div>";
			echo "<div class='rTableCell' style='width:50%;overflow: visible;background-color: #eee;'><div>PA<input type='radio' name='radiogroup$row[userId]' id='radio-1'></div></div></div>";
