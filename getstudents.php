...
<div class="rTableHead">RegNO</div>
...
$qdeptId=intval($_GET['deptId']);
	$sql = "SELECT u.user_id as userId,u.user_type as userType,u.first_Name as firstName,u.last_Name as lastName,u.email_Id as emailId,u.mobile_No as mobileNo,u.user_Name as userName,u.dept_id as deptId,d.dept_Name as deptName FROM user_tl u,dept_tl d where u.dept_id=d.dept_id and u.user_type='Student' and u.dept_id=$qdeptId and u.sem='$qsem'";
	...
	if ($count > 0) {
		while($row = $rs->fetch_assoc()) {
			...
			echo "<div class='rTableCell'>".$row["userName"]."</div></div>";
