            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
               <li ><a href="staffhome.php">Home</a></li>
                <li class="active"><a href="mysubjects.php">MySubjects</a></li>
				 <li><a href="myclassroom.php">Class Room</a></li>
...
<div class="rTableHead">SubjectTitle</div>
<div class="rTableHead">Sem</div>
</div>
</div>
...
<?php
	...
	if ($count > 0) {
		while($row = $rs->fetch_assoc()) {
			...
			echo"<div class='rTableCell'>".$row["subject_name"]."</div>";
			echo "<div class='rTableCell'>".$row["subject_code"]."</div>";
			echo "<div class='rTableCell'>".$row["semester"]."</div></div>";
			$sno=$sno+1;
